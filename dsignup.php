                ...
                <div class = "contact-right text-white text-center bg-blue">
                    ...
                    <div class="col-md-6">
                                    <div class="form-element">
                                        ...
                                        <input  name="txtemail" type="text" placeholder="Email" class="form-control input-md" required>
                                    </div>
                    </div>
                    <div class="col-md-6">
                                    <div class="form-element">
                    ...
                    <div class="col-md-6">
                                    <div class="form-element">
                                    <input name="txtcontact" type="number" placeholder="Contact" class="form-control input-md" required>
                                    </div>
                    </div>
                    <div class="col-md-6">
                                    <div class="form-element">
