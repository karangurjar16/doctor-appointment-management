        ...
        <section id="banner-one" class="banner-one text-center">
            <div class="container text-white">
                <blockquote class="lead"><i class="fas fa-quote-left"></i> When you are young and healthy, it never
                    occurs to you that in a single second your whole life could change. <i class="fas fa-quote-right"></i></blockquote>
                ...
                <div class="doc-panel-inner grid">
                    ...
                    <div class="doc-panel-item">
                        <div class="img flex">
                            ...
                            <div class="info text-center bg-blue text-white flex">
                                <p class="lead">Dr. Riva Tripathi</p>
                                <p class="text-lg">Dermatologist</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="doc-panel-item">
                        <div class="img flex">
                            ...
                            <div class="info text-center bg-blue text-white flex">
                                <p class="lead">Dr. Anita Sharma</p>
                                <p class="text-lg">Gynecologist</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form>
                        <div class="col-md-6">
                            <div class="form-element">
                                <input name="txtreg" type="text" placeholder="Enter Registration number" class="form-control input-md">
                            </div>
                        </div>
                        <!-- Text input-->
                        <div class="col-md-6">
                            <div class="form-element">
                                ...
                                <input name="txtowner" type="text" placeholder="Enter Owner Name" class="form-control input-md">
                            </div>
                        </div>
                        <div class="form-element">
